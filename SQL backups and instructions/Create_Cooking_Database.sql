...
CREATE TABLE liquid (
id INTEGER NOT NULL AUTO_INCREMENT, unit VARCHAR(255) NOT NULL, ml DECIMAL(6,2) NOT NULL, PRIMARY KEY (id)
);
...
CREATE TABLE flour (
id INTEGER NOT NULL AUTO_INCREMENT, unit VARCHAR(255) NOT NULL, g DECIMAL(6,2) NOT NULL, PRIMARY KEY (id)
);
...
CREATE TABLE temp (
id INTEGER NOT NULL AUTO_INCREMENT, unit VARCHAR(255) NOT NULL, c DECIMAL(6,2) NOT NULL, PRIMARY KEY (id)
);
